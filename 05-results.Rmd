...
df_age2$BORO_NM <- fct_infreq(df_age2$BORO_NM)
ggplot(df_age2, aes(BORO_NM))+
  geom_bar(fill="lightblue")+
  xlab("Boroughs")+
  ggtitle("The Distribution of Victims in 18-24 Age Group by Borough in New York City")
```
