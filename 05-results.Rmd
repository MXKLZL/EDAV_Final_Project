...
df_select <- df_select %>% mutate( color = ifelse(timerange == picked_time[1], "red", timerange) )
df_select <- df_select %>% mutate( color = ifelse(timerange == picked_time[2], "green", timerange) )
df_select <- df_select %>% mutate( color = ifelse(timerange == picked_time[3], "blue", timerange) )
