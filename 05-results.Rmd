...
In chapter 3, we have dropped some trivial crime types like "CRIMINAL MISCHIEF" and now we only pay attention to the common crime type happened in NYC. There are 11 types of crimes in total and we can see the frequency rank of them in the following graph.
```{r}
...
As we can see, THEFT is the most common crime in NYC and we deduce that this phenomenon may result from the low cost of theft. Offence also appears very common, because there are many different types of crime could be classified as OFFENCE. ARSON, MURDER and KIDNAPPING are the least common crimes in the dataset.
