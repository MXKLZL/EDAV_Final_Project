...
To make the ranking more easy to identify, we use log function to adjust each crime amount. As we can see, THEFT is the most
common crime in NYC and we deduce that this phenomenon may result from the low cost of theft. Offence also appears very common, because there are many different types of crime could be classified as OFFENCE. ARSON, MURDER and KIDNAPPING are the least common crimes in the dataset.
