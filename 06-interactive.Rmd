...
As we discuss in the previous chapters, Queens and Manhattan should be the two best boroughs for us. However, the best choice is base on our criteria and we also don't compare the safety level of the specific address in each borough. The following two interactive graphs provide several choices for both the time period and crime type for the person with different preferences and help people identify the most suitable place in each borough for them.
...
Different people may have different schedules. Some students may only have class in the afternoon so the time period they go to school should be 11 am - 3 pm. On the top right corner, there are several checkboxes. The audience may choose some time period based on their own schedule. And the crime distribution in New York City for the selected time period will appear on the map. The number in each circle shows the total number of crimes around the address near the area. You can click the circle shown on the graph to zoom into a smaller scope. Eventually, when the zoom becomes smaller enough, the circle will become pin push in the graph and if you click the pin push, it will show you the exact crime time, victim age group, victim sex, and victim race. 
...
Different people may have a different rank in the dangerousness of the crime types. For females, they may afraid of Rape more and want to choose address with no or extremely low Rape rate. For Male, they may want to live in place have less burglary and robbery. There are several checkboxes on the top right corner and users may choose the subset of crime type to choose the exact address in each borough based on their own crime rank. Same as the graph above, You can click the circle continuously to zoom into a smaller scope and click the pin push, it will show you the exact crime time, victim age group, victim sex, and victim race.  
